...
The results of the classification accuracy evaluation obtained through the overall percentage of hits (PG = observed correct) indicate that the pixel-based classification performed better than the OBIA-ML classification (90% vs. 81%). The lower performance of the OBIA classification may be due to the spatial resolution of the Landsat images (30 m), which prevents taking advantage of the major benefits of OBIA (elimination of the salt and pepper effect, greater precision in the definition of buildings, which in this case are subsegmented; incorporation of textural information) (Blaschke 2010).
As a conclusion, we propose that, to obtain more precise information about the distribution of urbanized and non-urbanized areas, we could use data with higher spatial resolution and work within subsectors within the study area (establish the computational region in those different subsectors). In addition, since we know that different classification conditions can alter the results, we propose that different segmentation thresholds should be explored; and use different elements (for example, spectral indexes that improve the discrimination of the classes with less spectral separability such as rock and urban (for instance those proposed by Waqar et al. 2012, which were not used in this first approximation).
All variations in the configuration of the classification strategies to be tested should be carried out following a systematic design and a veracity assessment to allow its comparison.
